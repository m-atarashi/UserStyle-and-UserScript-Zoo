...
// @namespace    https://github.com/m-atarashi/UserStyle-Zoo/Scrapbox
// @version      1.0
...
(function() {
    ...
    const BG_URLS = [
        {"url": "https://sample.com/blahblahblah1.jpg", "description": "sample image1"},
        {"url": "https://sample.com/blahblahblah2.jpg", "description": "sample image2"},
        {"url": "https://sample.com/blahblahblah3.jpg", "description": "sample image3"},
    ];
    ...
    setInterval(() => {
        change_bg(get_bg_url_rand(BG_URLS));
    }, BG_INTERVAL);
})();
